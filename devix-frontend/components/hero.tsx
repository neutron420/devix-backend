    ...
    <div className="min-h-screen bg-[#0038FF] flex flex-col font-sans selection:bg-[#CCFF00] selection:text-black relative overflow-hidden w-full">
        ...
        <div className="relative w-full max-w-5xl mx-auto flex flex-col items-center justify-center text-center z-10 mt-4 mb-16">
          ...
          <div className="w-full flex flex-col items-center relative z-10 space-y-2 md:space-y-4">
            ...
            <div className="w-full flex justify-start pl-[10%] md:pl-[25%] relative z-30">
              <h1 
                className="text-[clamp(3rem,12vw,160px)] font-black leading-[0.85] tracking-tighter text-[#CCFF00] m-0 p-0 uppercase"
                style={{ 
            ...
            {/* DEVIX / BUILDERS / QUESTIONS / CONCEPTS / LOGS */}
            <div className="w-full flex justify-center relative z-20">
              <h1 
                className="text-[clamp(3.2rem,15vw,220px)] font-black leading-[0.85] tracking-tighter text-white m-0 p-0 uppercase flex justify-center w-full"
                style={{ 
                  fontFamily: '"Arial Black", Impact, sans-serif',
                  textShadow: '1px 1px 0 #001A99, 2px 2px 0 #001A99, 3px 3px 0 #001A99, 4px 4px 0 #001A99, 5px 5px 0 #001A99, 6px 6px 0 #001A99, 7px 7px 0 #001A99, 8px 8px 0 #001A99, 9px 9px 0 #001A99, 10px 10px 0 #001A99, 11px 11px 0 #001A99, 12px 12px 0 #001A99, 13px 13px 0 #001A99, 14px 14px 0 #001A99'
                }}
              >
                <TextRotate
                  texts={["DEVIX", "BUILDERS", "QUESTIONS", "CONCEPTS", "LOGS"]}
            ...
            <div className="w-full flex justify-start pl-[15%] md:pl-[30%] relative z-10">
              <h1 
                className="text-[clamp(3rem,12vw,160px)] font-black leading-[0.85] tracking-tighter text-white m-0 p-0 uppercase"
                style={{ 
                  fontFamily: '"Arial Black", Impact, sans-serif',
                  textShadow: '1px 1px 0 #001A99, 2px 2px 0 #001A99, 3px 3px 0 #001A99, 4px 4px 0 #001A99, 5px 5px 0 #001A99, 6px 6px 0 #001A99, 7px 7px 0 #001A99, 8px 8px 0 #001A99, 9px 9px 0 #001A99, 10px 10px 0 #001A99, 11px 11px 0 #001A99, 12px 12px 0 #001A99, 13px 13px 0 #001A99, 14px 14px 0 #001A99'
                }}
          ...
          {/* Mobile Interactive Cards (Flex Row below typography stack on mobile) */}
          <div className="flex md:hidden gap-6 mt-8 px-4 justify-center w-full relative z-20">
            {/* Card 1 */}
            <div className="w-36 aspect-[3/3.5] bg-white/20 backdrop-blur-md border border-white/40 rounded-[1.5rem] p-4 flex flex-col items-center justify-center rotate-[-6deg] shadow-xl">
              <div className="w-14 h-14 bg-[#D2B48C] rounded-full flex items-center justify-center mb-2 shadow-inner border-[2px] border-white/50 overflow-hidden">
              ...
              <div className="text-center mt-1">
                <p className="font-bold text-xs text-white">devix.eth</p>
                <p className="text-[9px] text-white/80 mt-0.5">1,024 commits</p>
              </div>
            </div>

            {/* Card 2 */}
            <div className="w-36 aspect-[3/3.5] bg-white/20 backdrop-blur-md border border-white/40 rounded-[1.5rem] p-4 flex flex-col items-center justify-center rotate-[6deg] shadow-xl">
              <div className="w-14 h-14 bg-[#2C3E50] rounded-full flex items-center justify-center mb-2 shadow-inner border-[2px] border-white/50 overflow-hidden">
                <img src="https://api.dicebear.com/7.x/pixel-art/svg?seed=John" alt="Avatar" className="w-full h-full object-cover scale-150" />
              </div>
              <div className="text-center mt-1">
                <p className="font-bold text-xs text-white">coder.eth</p>
                <p className="text-[9px] text-white/80 mt-0.5">4,096 commits</p>
              </div>
            </div>
          </div>
          ...
          <div className="absolute inset-0 w-full h-full pointer-events-none">
            ...
            {/* Floating Glass Card 1 (Bottom Left) - Hidden on mobile */}
            <motion.div 
              animate={{ y: [0, -15, 0] }}
              transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
              className="hidden md:block absolute bottom-[10%] left-[20%] z-30 pointer-events-auto"
            >
              <div className="w-40 md:w-52 aspect-[3/3.5] bg-white/20 backdrop-blur-md border border-white/40 rounded-[2rem] p-5 flex flex-col items-center justify-center rotate-[-12deg] shadow-2xl hover:rotate-0 transition-transform duration-500">
                ...
                <div className="text-center mt-2">
                  <p className="font-bold text-sm md:text-lg text-white">devix.eth</p>
                  <p className="text-[10px] md:text-xs text-white/80 mt-1">1,024 commits</p>
                </div>
              </div>
            </motion.div>

            {/* Floating Glass Card 2 (Top Right) - Hidden on mobile */}
            <motion.div 
              animate={{ y: [0, -20, 0] }}
              transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1 }}
              className="hidden md:block absolute top-[15%] right-[22%] z-30 pointer-events-auto"
            >
              <div className="w-40 md:w-52 aspect-[3/3.5] bg-white/20 backdrop-blur-md border border-white/40 rounded-[2rem] p-5 flex flex-col items-center justify-center rotate-[12deg] shadow-2xl hover:rotate-0 transition-transform duration-500">
                ...
                <div className="text-center mt-2">
                  <p className="font-bold text-sm md:text-lg text-white">coder.eth</p>
                  <p className="text-[10px] md:text-xs text-white/80 mt-1">4,096 commits</p>
                </div>
              </div>
            </motion.div>

            {/* Decorative Arrow Left - Hidden on mobile */}
            <div className="hidden md:block absolute bottom-[0%] left-[10%] w-32 h-32 z-20">
              <ArrowGreenLeft />
            </div>

            {/* Decorative Arrow Right - Hidden on mobile */}
            <div className="hidden md:block absolute top-[5%] right-[10%] w-32 h-32 z-20">
              <ArrowGreenRight />
            </div>

            {/* Circular Badge - Hidden on mobile */}
            <div className="hidden md:block absolute bottom-[-10%] right-[15%] z-40 pointer-events-auto">
              <CircularBadge />
            </div>
      ...
      <section className="bg-white text-black rounded-t-[2.5rem] md:rounded-t-[3.5rem] px-6 py-12 md:px-10 md:py-16 relative z-20 shadow-[0_-20px_50px_rgba(0,0,0,0.2)] mt-auto w-full">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="relative w-full flex justify-center mt-6">
              <div className="flex items-center bg-[#0038FF] rounded-2xl p-2 pr-16 text-white shadow-lg relative z-10">
                ...
                <div className="text-left">
                  <p className="text-[10px] font-bold leading-none">devix.eth</p>
                  <p className="text-[8px] text-white/70 leading-none mt-1">1,024 commits</p>
                </div>
              </div>
          ...
          <div className="bg-[#F8F9FA] rounded-[2rem] p-8 flex flex-col items-center text-center relative h-64 border border-gray-100">
            <h3 className="text-xl md:text-2xl uppercase leading-tight mb-2 font-black">
              VERIFIABLE<br/>REPUTATION GRAPH
            </h3>
            <p className="text-[10px] md:text-xs text-black/60 font-bold mb-auto">
              every contribution builds your developer identity
            </p>
          ...
          <div className="bg-[#F8F9FA] rounded-[2rem] p-8 flex flex-col items-center text-center relative h-64 border border-gray-100">
            <h3 className="text-xl md:text-2xl uppercase leading-tight mb-2 font-black">
              STAKE TOKENS<br/>FOR PROJECTS
            </h3>
            <p className="text-[10px] md:text-xs text-black/60 font-bold mb-auto">
              support open-source public goods
            </p>
            ...
            <div className="flex flex-col items-center bg-[#CCFF00] rounded-[2rem] px-6 py-4 text-black shadow-lg mt-6 relative w-full max-w-[200px]">
              <p className="text-[9px] font-bold uppercase tracking-wider mb-1">EST. Monthly Yield</p>
              <p className="text-xl font-black">18.84% APY</p>
